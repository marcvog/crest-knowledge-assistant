...
from crest_knowledge_assistant.indexing.vector_store import SearchHit, VectorStore
...
class RAGPipeline:
    def __init__(self):
        ...
        self.embedder = Embedder(
            embedding_model, embedding_dimensions, provider=embedding_provider
        )
...
def main() -> None:
    ...
    for i, hit in enumerate(hits, start=1):
        print(f"{i}. {hit.metadata['qualified_name']} (score={hit.score:.4f})")
